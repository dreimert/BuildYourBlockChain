...
test('Vérification de la propagation de valeur', function (t) {
  return execCommande('node ./cli.js --port=7350 --bot=true set casque quest2', t).then(({ stdout, stderr }) => {
    t.equal(stdout, 'OK\n', 'Set doit réussir')
  }).then(() => {
...
test('Vérification de la propagation d\'une seconde valeur', function (t) {
  return execCommande('node ./cli.js --port=7350 --bot=true set jeu beatsaber', t).then(({ stdout, stderr }) => {
    t.equal(stdout, 'OK\n', 'Set doit réussir')
  }).then(() => {
